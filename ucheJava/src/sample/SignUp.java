...
public class SignUp implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            File file = new File("C:\\Users\\Ekeoma\\Desktop\\INEC.accdb");
        ...
        ResultSet rs;
            ...
            if (validateFields() & validateFirstName() & validateLastName() & validateAge() & validateEmail() & validatePass()) {
                try {
                    ...
                    conn = DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\Ekeoma\\Desktop\\INEC.accdb");
                    String sql2 = "select * from Login_Table";
                    ...
                    if (a > 0 | rs.next()) {
                        int id = rs.getInt("ID");
                        Alert alert = new Alert(Alert.AlertType.INFORMATION, "You've successfully Signed Up! Click the Login button to return to the login page and Login" +
                                "\nYour ID no has been sent to the database please check there for Your ID"+
                                "\nPlease Write this ID  as it will be used to verify your voting license!");
